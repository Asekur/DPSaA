...
begin
  ...
  writeln('Ввведите количество элементов в первом списке:');
  readln(count);
  st := nil;
  PFirstTask := nil;
  Psecondtask := nil;
  writeln('Ввведите элементы первого списка:');
  for i := 1 to count do
  begin
    readln(buf.id);
  ...
  writeln;
  writeln('Ввведите количество элементов во втором списке');
  readln(count);
  writeln('Ввведите элементы второго списка:');
  for i := 1 to count do
  begin
    readln(buf.id);
